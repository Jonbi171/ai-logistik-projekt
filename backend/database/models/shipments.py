...
class Shipments(Base):
    ...
    shipment_type: Mapped[str] = mapped_column(
        ENUM(
            ...
            "INBOUND",
            "TRANSFER",
            name="shipment_shipment_types", create_type=False), nullable=False
    )
    ...
    transport_mode: Mapped[str] = mapped_column(
        ENUM(
            ...
            "AIR",
            "OCEAN",
            name="shipment_transport_modes", create_type=False), nullable=False
    )
    service_level: Mapped[str] = mapped_column(
        ENUM(
            "STANDARD",
            "EXPRESS",
            name="shipment_service_levels", create_type=False), nullable=False
    )
    ...
    status: Mapped[str] = mapped_column(
        ENUM(
            ...
            "DELAYED",
            "CANCELLED",
            name="shipment_statuses", create_type=False), nullable=False
    )
